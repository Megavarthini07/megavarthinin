...
<div class="container">
    ...
    <div class="btn-group">
        ...
        <a href="viewmarks.php" class="btn btn-success">Mark Details</a>
        <a href="viewremedial.php" class="btn btn-info">Remedial Details</a>
        <a href="attendance.php" class="btn btn-warning">Remedial Attendance</a>
    </div>
</div>
